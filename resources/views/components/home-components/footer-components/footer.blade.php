<div class="bg-shade mt-40 h-fit pb-4 lg:flex sm:block">
        ...
        <div class="flex flex-col sm:justify-start sm:items-start justify-center items-center 2xl:ml-72 md:ml-36 sm:ml-28 ml-10 2xl:pt-24 pt-16">
            ...
            <div class="flex justify-center items-center h-12 2xl:mt-8 mt-4 2xl:w-96 w-80">
                <input type="text" name="" id=""
                    class="absolute bg-white rounded-sm 2xl:w-96 w-80 h-12 pl-4 pr-32 focus:outline-none"
                    placeholder="Enter Email Address">
                <button class="absolute 2xl:ml-64 ml-56 rounded-sm 2xl:w-32 w-24 h-11 bg-pink text-white text-base">Sign
                    up</button>
            </div>
            <div class="mt-6">
            ...
            <div class="mt-2">
                <x-home-components.footer-components.link :link="'https://goo.gl/maps/YW9sBfeoqsaCiLmf6'"
    ...
    <div class="flex justify-center">
        ...
        <div class="flex flex-col 2xl:ml-20 ml-12 2xl:pt-24 pt-16">
            ...
            <div class="2xl:mt-11 mt-8">
                <x-home-components.footer-components.link :link="'/pages//blog'" :text="'Blog'" />
            </div>
            <div class="2xl:mt-5 mt-3">
                <x-home-components.footer-components.link :link="'/pages/shop'" :text="'Browse the shop'" />
            </div>
            <div class="2xl:mt-5 mt-3">
                <x-home-components.footer-components.link :link="'/pages/categories'" :text="'Category'" />
            </div>
            <div class="2xl:mt-5 mt-3">
