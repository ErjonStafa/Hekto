<div class="2xl:ml-96 lg:ml-64 md:ml-28 sm:ml-20 ml-4 2xl:mt-24 mt-16 flex flex-wrap items-center">
    <div class="flex items-center pb-3">
        ...
        <div class="inline-flex sm:ml-5 ml-2 font-lato sm:text-base text-sm text-[#3F509E]">
            <div>Per Page:</div>
            <input type="number" name="products-per-page"
                class="ml-1 w-14 h-6 pl-1 text-sub-text-color text-xs focus:outline-none box-border border border-lightgrey">
        </div>
    </div>
    <div class="flex items-center">
        ...
        <div class="inline-flex sm:ml-5 ml-2 font-lato sm:text-base text-sm text-off-navy-blue">
            <div>Sort By: </div>
            <select name="sorting"
                class="ml-1 w-24 cursor-pointer text-sub-text-color text-xs focus:outline-none box-border border border-lightgrey">
                <option value="name" {{ str_contains($url, '/order-by-price')? "":"selected" }}>Name</option>
                <option value="price" {{ str_contains($url, '/order-by-price')? "selected":"" }}>Price</option>
            </select>
        </div>
        <div class="flex justify-center items-center ml-5 font-lato sm:text-base text-sm text-off-navy-blue">
            ...
            <input type="text"
                class="ml-4 w-40 h-7 text-sub-text-color text-xs px-2 focus:outline-none border border-lightgrey">
        </div>
    </div>
</div>